var APP_LANG = {
    ...
    "app.payment_status_after_number": "Номер статуса заказа после оплаты",
    "app.payment_status_number": "Номер статуса заказа для оплаты",
    "app.max_user_files_size": "Максимальный размер файлов пользователей, МБ",
    "app.max_temp_files_keep_minutes": "Время хранения временных файлов, мин.",
