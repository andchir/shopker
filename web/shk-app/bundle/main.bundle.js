...
var ContentTypeModalContent = (function () {
    ...
    ContentTypeModalContent.prototype.buildForm = function () {
        ...
        this.fieldForm = this.fb.group({
            ...
            name: ['', [__WEBPACK_IMPORTED_MODULE_5__angular_forms__["h" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_5__angular_forms__["h" /* Validators */].pattern('[A-Za-z0-9_-]+')]],
            description: ['', []],
            input_type: ['', [__WEBPACK_IMPORTED_MODULE_5__angular_forms__["h" /* Validators */].required]],
            output_type: ['', [__WEBPACK_IMPORTED_MODULE_5__angular_forms__["h" /* Validators */].required]],
            is_filter: ['', []],
            required: ['', []],
            group: ['', [__WEBPACK_IMPORTED_MODULE_5__angular_forms__["h" /* Validators */].required]],
            new_group: ['', []]
        });
    ...
    ContentTypeModalContent.prototype.selectFieldTypeProperties = function (type, name) {
    ...
    ContentTypeModalContent.prototype.editField = function (field) {
        var defaults = new __WEBPACK_IMPORTED_MODULE_6__models_content_field_model__["a" /* ContentField */]('', '', '', '', '', [], '', [], '', false, false);
        field = __WEBPACK_IMPORTED_MODULE_10_lodash__["extend"](defaults, field);
        this.fieldForm.setValue(__WEBPACK_IMPORTED_MODULE_10_lodash__["omit"](field, ['id', 'input_type_options', 'output_type_options']));
    ...
    ContentTypeModalContent.prototype.copyField = function (field) {
        var data = __WEBPACK_IMPORTED_MODULE_10_lodash__["clone"](field);
        data.name = '';
