...
var InputFieldRenderComponent = (function () {
    ...
    InputFieldRenderComponent.prototype.setFieldOptions = function (field) {
        ...
        switch (field.inputType) {
            ...
            case 'checkbox':
            case 'select':
                var valueArr = field.inputProperties.value
                    ? field.inputProperties.value.split('||')
                    : [];
                valueArr.forEach(function (optStr) {
                    field.options.push(__WEBPACK_IMPORTED_MODULE_2_lodash__["zipObject"](['title', 'value'], optStr.split('==')));
                });
                break;
        }
    };
